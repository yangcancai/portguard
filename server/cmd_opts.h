...
static char *config_map[NUMBER_OF_CONFIG_ENTRIES] = {
    ...
    "AFL_PKT_FILE",
#endif
    "PORTGUARD_CLIENT_SERVER",
    "PORTGUARD_SECTION_NAME",
    "PORTGUARD_ALLOW_IP",
    "PORTGUARD_TG_BOT_TOKEN",
    "PORTGUARD_TG_CHAT_ID",
    "PORTGUARD_TG_NOTIFY_INTERVAL",
    "FAULT_INJECTION_TAG"
};
...
static struct option cmd_opts[] =
{
    ...
    {"verbose",                 0, NULL, 'v'},
    {"version",                 0, NULL, 'V'},
    {"firewall-cmd-check-support", 0, NULL, FIREWD_DISABLE_CHECK_SUPPORT },
    {"iptables-check-support",  0, NULL, IPT_DISABLE_CHECK_SUPPORT },
