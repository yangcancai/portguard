...
Description: PortGuard Single Packet Authorization server
 PortGuard Server packages fwknopd for easy SPA deployment. Release packages
 contain no working default keys; fwknopd generates unique access keys on its
 first startup. The official install.sh also configures client import payloads.
EOF
